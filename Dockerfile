...
RUN graalpy -m venv portfolio_advisor_venv
RUN source portfolio_advisor_venv/bin/activate
...
CMD ["mvn", "spring-boot:run", "-Dspring-boot.run.jvmArguments=-Dh2.tcpPort=9092 -Dh2.tcpAllowOthers"]
